...
import { tiers, frequencies } from './common'
...
export default function Pricing() {
  ...
  const {userData, showLoginModal, setShowLoginModal} = useCommonContext()
            ...
            >
              ...
              </p>
              {
                ...
                >
                  ...
                  onClick={() => {
                    if(tier.id == 'tier-freelancer') {
                      toast.info('free subscription do not need to be buy')
                    } else {
                      handleCheckout({
                        tierId: tier.id,
                        price: tier.priceStripe[frequency.value]
                      })
                    }
